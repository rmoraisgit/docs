...
### [🧩 Composição de Componentes com `children` e Slots](composition-patterns-section-tabs.md)
Explora os padrões de composição em React usando `children`, repasse de props e componentes baseados em slots. Exemplos com `Section`, `Tabs` e `TabButton`.
